...
const ProductDetails = () => {
  ...
  return (
    product && (
      <div className="mt-12">
        <p>
          <Link>Home</Link> /<Link to={"/products"}> Products</Link> /
        ...
        <div className="flex flex-col items-center mt-20">
          <div className="flex flex-col items-center">
            ...
            <div className="w-20 h-0.5 bg-indigo-600 rounded-full mt-2">
                  </div>
            ...
            <button
              ...
              className=" mx-auto cursor-pointer bg-indigo-500 px-12 my-16  text-white"
            >
              See More
            </button>
          </div>
